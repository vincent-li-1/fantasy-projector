...
public class TeamTest {
    ...
    public static void init() {
        ...
        int[][] offensiveStats = new int[][]{oRS, oPS, oRTD, oPTD, oTO, oREC};
        int[][] defensiveStats1 = new int[][]{dRS1, dPS1, dRTD1, dPTD1, dTO1, dREC1};
        ...
        int[][] defensiveStats2 = new int[][]{dRS2, dPS2, dRTD2, dPTD2, dTO2, dREC2};
        ...
        int[][] defensiveStats3 = new int[][]{dRS3, dPS3, dRTD3, dPTD3, dTO3, dREC3};
        ...
        int[][] defensiveStats4 = new int[][]{dRS4, dPS4, dRTD4, dPTD4, dTO4, dREC4};
        ...
        int[] dRS5 = new int[]{101, 102};
        int[] dPS5 = new int[]{501, 502};
        int[] dRTD5 = new int[]{0, 1};
        int[] dPTD5 = new int[]{3, 4};
        int[] dTO5 = new int[]{1, 1};
        int[] dREC5 = new int[]{30, 33};

        int[][] defensiveStats5 = new int[][]{dRS5, dPS5, dRTD5, dPTD5, dTO5, dREC5};
    ...
    public void testExpectedStatsAgainstOpp() {
        float[] expectedStats = new float[]{117.26f, 602.76f, 0.36f, 5.02f, 0.51f, 40.18f};
